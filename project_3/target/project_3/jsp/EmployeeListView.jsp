		...
		<div class="row align-items-start" style="padding-left: 20px;">
			...
			<div class="col-sm-2 error-container">
				<input type="text" name="name" placeholder="Enter Name"
					...
					oninput="handleLetterInput(this, 'nameError', 60)"
					onblur="validateLetterInput(this, 'nameError', 60)">
				<div id="nameError" class="error-message"></div>
			</div>

			<div class="col-sm-3">
				<div class="input-group">
					<%=HTMLUtility.getList("department", dto.getDepartment(), map)%>
				</div>
			</div>
			
			<div class="col-sm-2">
				<input type="text" id="datepicker2" name="dateOfJoining" class="form-control"
			...
			<div class="col-sm-3 error-container">
				<input type="text" name="lastEmployeeName" placeholder="Enter lastEmployerName"
					class="form-control"
					value="<%=ServletUtility.getParameter("lastEmployeeName", request)%>"
					id="lastEmployeeName" oninput="handleLetterInput(this, 'lastEmployeeNameError', 100)"
					onblur="validateLetterInput(this, 'lastEmployeeNameError', 100)">
				<div id="lastEmployeeNameError" class="error-message"></div>
			</div>
